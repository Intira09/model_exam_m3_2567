...
# ---------------- ข้อมูลนักเรียน ----------------
raw_student_answer = """ไม่เห็นด้วยอย่างมากเพราะการที่เราใช้สื่อมากเกินไปอาจจะทำให้เรา
และคนรอบข้างได้รับพลก้ระทบอย่างรุนแรงได้ทั้งนี้สื่อออนไลน์ก็มีข้อ
ดีและข้อเสียแตกต่างกันออกไป เราควรรู้ทันสื่อออนไลน์ให้มากกว่า
นี้ไม่นั้นอาจจะพบ กับมิจฉาชีพเอาได้ปัจจุบันพบเห็นผู้สูงอายุจำ
นวนมากและเด็กถูกมิจฉาชีพหลอกมีทั้งออกตังค์และหลอกโปตางประ
เทศบ้างเราจึงควรรู้ทันและป้องกันคนที่เรารักไม่ให้หากมิจฉาชีพมัน
หลอกเราได้"""
...
# ---------------- Keyword ----------------
subject_keywords = ["สื่อสังคม", "สื่อออนไลน์", "สื่อสังคมออนไลน์", "สื่อ", "การ",
                    "ที่", "และ", "เห็นด้วย", "ไม่เห็นด้วย", "ต่าง ๆ", "ไม่",
                    "ทุกวัย", "ทุกเพศ", "เป็นต้น"]
object_keywords = ["ข้อมูลข่าวสาร", "ข้อมูล", "ข่าวสาร",
